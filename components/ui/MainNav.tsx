      ...
      <nav className="color-red ">
        <div className="max-w-7xl mx-auto px-4">
          <div className="hidden sm:flex justify-evenly space-x-8 py-2 text-white font-semibold">
            <Link href="/home" className="hover:text-gray-200 text-2xl">
              Inicio
            </Link>
            <Link href="/about" className="hover:text-gray-200 text-2xl">
              Nosotros
            </Link>
            <Link href="/categories" className="hover:text-gray-200 text-2xl">
              Productos
            </Link>
            <Link href="/contact" className="hover:text-gray-200 text-2xl">
              Contacto
            </Link>
          </div>
          ...
          >
            <div className="flex flex-col items-start space-y-2 py-2 text-white font-semibold">
              <Link href="/home" className="block hover:text-gray-200">
                Inicio
              </Link>
              <Link href="/about" className="block hover:text-gray-200">
                Nosotros
              </Link>
              <Link href="/categories" className="block hover:text-gray-200">
                Productos
              </Link>
